...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			div2.innerHTML = `<div class="about-image-inner svelte-1euwv4c"><img alt="me putting in eye drops" src="../img/eyedrop.webp" class="svelte-1euwv4c"/> 
      <div class="about-image-inner-caption svelte-1euwv4c">Me putting in eye drops</div></div>`;

    			t2 = space();
    			div6 = element("div");
    			div3 = element("div");
    			div3.innerHTML = `<h2 class="svelte-1euwv4c">About Me</h2>`;
    			t4 = space();
    			div4 = element("div");
        ...
        project, feel free to send an email or contact me on Twitter!</span>`;
    			...
    			attr(div2, "class", "about-image scroll-reveal-slide-left svelte-1euwv4c");
    			attr(div3, "class", "about-desc-title svelte-1euwv4c");
    			attr(div4, "class", "about-desc-sentence svelte-1euwv4c");
    			attr(div5, "class", "data");
    			attr(div6, "class", "about-desc scroll-reveal svelte-1euwv4c");
    			attr(div7, "class", "about svelte-1euwv4c");
    		},
    		m(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			div3 = element("div");
    			div0 = element("div");
    			div0.innerHTML = `<h1 class="svelte-13idpqt">Kota Yatagai</h1>`;
    			t1 = space();
    			div1 = element("div");
    			div1.innerHTML = `<h3 class="svelte-13idpqt">High school student &amp; Front-end developer</h3>`;
    			t3 = space();
    			div2 = element("div");
    			div2.innerHTML = `<a href="https://github.com/kota-yata"><img class="github svelte-13idpqt" alt="github" src="../svg/github.svg"/></a>`;
    			t4 = space();
    			div4 = element("div");
    			attr(div0, "class", "top-left-name svelte-13idpqt");
    			attr(div1, "class", "top-left-desc svelte-13idpqt");
    			attr(div2, "class", "top-left-icon svelte-13idpqt");
    			attr(div3, "class", "top-left svelte-13idpqt");
    			attr(div4, "class", "top-right svelte-13idpqt");
    			attr(div5, "class", "top svelte-13idpqt");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(img, "class", "svelte-upfyjy");
    			attr(a, "href", /*url*/ ctx[0]);
    			attr(div0, "class", "workcard-image svelte-upfyjy");
    			attr(div1, "class", "workcard-desc svelte-upfyjy");
    			attr(div2, "class", div2_class_value = "workcard " + /*className*/ ctx[3] + " svelte-upfyjy");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*className*/ 8 && div2_class_value !== (div2_class_value = "workcard " + /*className*/ ctx[3] + " svelte-upfyjy")) {
    ...
    // (76:6) {#each workCardAlgorithm as { url, alt, src, className, desc }}
    ...
    // (86:6) {#each workCardWeb as { url, alt, src, className, desc }}
    ...
    // (96:6) {#each workCardNpm as { url, alt, src, className, desc }}
    ...
    function create_fragment$9(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h3, "class", "svelte-bresp2");
    			attr(div1, "class", "skillcard-red-title svelte-bresp2");
    			attr(div2, "class", "skillcard-red svelte-bresp2");
    			attr(div3, "class", "skillcard-desc svelte-bresp2");
    			attr(div4, "class", div4_class_value = "skillcard " + /*className*/ ctx[1] + " svelte-bresp2");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*className*/ 2 && div4_class_value !== (div4_class_value = "skillcard " + /*className*/ ctx[1] + " svelte-bresp2")) {
    ...
    function create_fragment$d(ctx) {
    	...
    	return {
    		c() {
    			...
    			footer.innerHTML = `<h3 class="svelte-119vgvi">© 2021 Kota Yatagai</h3>`;
    			attr(footer, "class", "svelte-119vgvi");
    		},
    		m(target, anchor) {
